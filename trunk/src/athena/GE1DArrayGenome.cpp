...
void GE1DArrayGenome::addGeno(int g)
{genos.push_back(g);}


void GE1DArrayGenome::addGenos(vector<int> g){
	genos=g;
}
...
void GE1DArrayGenome::addCovars(vector<int> c){
	covars = c;
}

vector<int>& GE1DArrayGenome::getCovars()
{return covars;}
