...
public:
		...
		void setMultiCategory(bool tf){multiCat=tf;}
		bool getMultiCategory(){return multiCat;}
...
private:
		...
		bool idIncluded, ottDummyEncoded, cvOut, indsOutput, allNodesOut, selectBest, multiCat;
