...
// cout << "terminal added " << newSymbol << "<-- " << endl;
                    // add check for multiple genotype or continuous variables
                    // these are of the format G1-20 or C2-4 and specify
                    // which variables will be included
//                     if(newSymbol[0] == 'V' && (newSymbol[1] >= '0' && newSymbol[1] <= '9') && 
//                       newSymbol.find("-") != string::npos){
//                       cout << " found variable" << endl;
//                       addMultiVariables(currentRule, newSymbol);
//                     }
//                     else{
  										newProduction.push_back(new Symbol(newSymbol));
//   								  }
...
///////////////////////////////////////////////////////////////////////////////
// Adds multiple variables to the network at one time
void CFGrammar::addMultiVariables(Rule* currentRule, string symbol){
